...
class AnimesControllerTest < ActionController::TestCase
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post :create, anime: { eps: @anime.eps, finished: @anime.finished, title: @anime.title, type: @anime.type }
    end
  ...
  test "should update anime" do
    put :update, id: @anime, anime: { eps: @anime.eps, finished: @anime.finished, title: @anime.title, type: @anime.type }
    assert_redirected_to anime_path(assigns(:anime))
  end
